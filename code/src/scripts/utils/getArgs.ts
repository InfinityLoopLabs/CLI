...
const getType = (value: string) => {
    ...
    switch (value.toLowerCase()) {
        ...
        case TemplatesEnum.page:
            ...
            break
        case TemplatesEnum.feature:
            type = TemplatesEnum.feature
            break
        default:
            console.log(
                '\x1b[31m',
                `First argument must be service, widget, feature or page`,
                '\x1b[0m'
            )
            break
    }
...
const getName = (value: string, type: string) => {
    ...
    const firstLetterToRightCase =
        type === TemplatesEnum.widget
            ...
            : type === TemplatesEnum.service ? firstLetter.toLowerCase() : firstLetter
